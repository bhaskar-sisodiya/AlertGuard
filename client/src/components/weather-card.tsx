...
const getWeatherIconUrl = (icon?: string) => {
  ...
  // ✅ OpenWeather style: "https://openweathermap.org/img/wn/10d@2x.png"
  if (icon.startsWith("http://") || icon.startsWith("https://")) return icon;

  // ✅ WeatherAPI style: "//cdn.weatherapi.com/..."
...
export function WeatherCard() {
  ...
  const iconUrl = getWeatherIconUrl(weather.current?.condition?.icon);
